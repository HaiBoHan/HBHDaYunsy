 ...
 ***********************************************************************************************/
namespace AccountPeriodRef
{
    public partial class AccountPeriodRefWebPart
    {
        ...
        {
            this.Model.cRef.FieldAccountingCalendar_Description.AttributeName = "(convert(varchar,Year,125) + '-' + convert(varchar,Month,125))";
